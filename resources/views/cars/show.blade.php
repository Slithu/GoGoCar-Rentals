...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center bg-primary text-white">Show Car</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea id="description" maxlength="1500" rows="5" class="form-control" name="description" disabled>{{ $car->description }}</textarea>
                        </div>
                    </div>

                    <a class="nav-link" href="{{ route('cars.index') }}" style="text-align:center">
                        <button class="btn btn-secondary btn-sm">Return to Cars Fleet</button>
                    </a>
                </div>
            </div>
        </div>
