            ...
            @foreach ($payments as $payment)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('payment.destroy', $payment->id) }}" class="d-inline delete-form" id="delete-form-{{ $payment->id }}">
                            <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $payment->id }})">Delete</button>
                        </form>
                    </td>
                </tr>
            @endforeach
...
<script>
    ...
    function confirmDelete(paymentId) {
        deleteFormId = 'delete-form-' + paymentId;
